...
void stepPhysics(bool interactive)
{
	...
	PxVehicleSuspensionRaycasts(gBatchQuery, 1, vehicles, gVehicleSceneQueryData->getRaycastQueryResultBufferSize(), gVehicleSceneQueryData->getRaycastQueryResultBuffer(0));
