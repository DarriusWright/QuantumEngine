...
#if defined(WIN32) && !defined(PX_XBOXONE) && !defined (RENDERER_WINMODERN)
...
void SampleCCTCameraController::collectInputEvents(std::vector<const SampleFramework::InputEvent*>& inputEvents)
{
	...
	DIGITAL_INPUT_EVENT_DEF(CAMERA_CROUCH,				SCAN_CODE_DOWN,			XKEY_C,			X1KEY_C,		PS3KEY_C,			PS4KEY_C,			AKEY_UNKNOWN,	SCAN_CODE_DOWN,		PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	SCAN_CODE_DOWN,		WIIUKEY_UNKNOWN);
	DIGITAL_INPUT_EVENT_DEF(CAMERA_CONTROLLER_INCREASE,	WKEY_ADD,				XKEY_ADD,		X1KEY_ADD,		PS3KEY_ADD,			PS4KEY_ADD,			AKEY_UNKNOWN,	OSXKEY_ADD,			PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	LINUXKEY_ADD,		WIIUKEY_UNKNOWN);
	DIGITAL_INPUT_EVENT_DEF(CAMERA_CONTROLLER_DECREASE,	WKEY_SUBTRACT,			XKEY_SUBTRACT,	X1KEY_SUBTRACT,	PS3KEY_SUBTRACT,	PS4KEY_SUBTRACT,	AKEY_UNKNOWN,	OSXKEY_SUBTRACT,	PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	LINUXKEY_SUBTRACT,	WIIUKEY_UNKNOWN);
	...
	DIGITAL_INPUT_EVENT_DEF(CAMERA_CROUCH,				GAMEPAD_LEFT_STICK,			GAMEPAD_LEFT_STICK,			GAMEPAD_LEFT_STICK,			GAMEPAD_LEFT_STICK,			GAMEPAD_LEFT_STICK,			AKEY_UNKNOWN,	GAMEPAD_LEFT_STICK,			GAMEPAD_WEST,		IKEY_UNKNOWN, LINUXKEY_UNKNOWN, GAMEPAD_LEFT_STICK);
	DIGITAL_INPUT_EVENT_DEF(CAMERA_CONTROLLER_INCREASE,	GAMEPAD_RIGHT_SHOULDER_TOP,	GAMEPAD_RIGHT_SHOULDER_TOP,	GAMEPAD_RIGHT_SHOULDER_TOP,	GAMEPAD_RIGHT_SHOULDER_TOP,	GAMEPAD_RIGHT_SHOULDER_TOP,	AKEY_UNKNOWN,	GAMEPAD_RIGHT_SHOULDER_TOP,	PSP2KEY_UNKNOWN,	IKEY_UNKNOWN, LINUXKEY_UNKNOWN,	GAMEPAD_RIGHT_SHOULDER_TOP);
	DIGITAL_INPUT_EVENT_DEF(CAMERA_CONTROLLER_DECREASE,	GAMEPAD_LEFT_SHOULDER_TOP,	GAMEPAD_LEFT_SHOULDER_TOP,	GAMEPAD_LEFT_SHOULDER_TOP,	GAMEPAD_LEFT_SHOULDER_TOP,	GAMEPAD_LEFT_SHOULDER_TOP,	AKEY_UNKNOWN,	GAMEPAD_LEFT_SHOULDER_TOP,	PSP2KEY_UNKNOWN,	IKEY_UNKNOWN, LINUXKEY_UNKNOWN,	GAMEPAD_LEFT_SHOULDER_TOP);
