...
void DefaultCameraController::collectInputEvents(std::vector<const InputEvent*>& inputEvents)
{
	...
	DIGITAL_INPUT_EVENT_DEF(CAMERA_MOVE_UP,			SCAN_CODE_UP,			XKEY_E,			X1KEY_E,			PS3KEY_E,		PS4KEY_E,		AKEY_UNKNOWN,	SCAN_CODE_UP,		PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	SCAN_CODE_UP,		WIIUKEY_UNKNOWN);
	DIGITAL_INPUT_EVENT_DEF(CAMERA_MOVE_DOWN,		SCAN_CODE_DOWN,			XKEY_C,			X1KEY_C,			PS3KEY_C,		PS4KEY_C,		AKEY_UNKNOWN,	SCAN_CODE_DOWN,		PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	SCAN_CODE_DOWN,		WIIUKEY_UNKNOWN);
	...
	DIGITAL_INPUT_EVENT_DEF(MOUSE_LOOK_BUTTON,		MOUSE_BUTTON_LEFT,		XKEY_UNKNOWN,	X1KEY_UNKNOWN,	PS3KEY_UNKNOWN,	PS4KEY_UNKNOWN,	AKEY_UNKNOWN,	MOUSE_BUTTON_LEFT,	PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	LINUXKEY_UNKNOWN,	WIIUKEY_UNKNOWN);

	//digital gamepad events
	DIGITAL_INPUT_EVENT_DEF(CAMERA_SPEED_INCREASE,	GAMEPAD_LEFT_STICK,		GAMEPAD_LEFT_STICK,		GAMEPAD_LEFT_STICK,		GAMEPAD_LEFT_STICK,		GAMEPAD_LEFT_STICK,	AKEY_UNKNOWN,	OSXKEY_UNKNOWN,	PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	LINUXKEY_UNKNOWN,	GAMEPAD_LEFT_STICK);
	DIGITAL_INPUT_EVENT_DEF(CAMERA_SPEED_DECREASE,	GAMEPAD_RIGHT_STICK,	GAMEPAD_RIGHT_STICK,	GAMEPAD_RIGHT_STICK,	GAMEPAD_LEFT_STICK,		GAMEPAD_LEFT_STICK,	AKEY_UNKNOWN,	OSXKEY_UNKNOWN,	PSP2KEY_UNKNOWN,	IKEY_UNKNOWN,	LINUXKEY_UNKNOWN,	GAMEPAD_RIGHT_STICK);
