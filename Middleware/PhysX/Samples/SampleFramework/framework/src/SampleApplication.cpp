...
void SampleApplication::onOpen(void)
{
	...
	physx::string::strcat_s(assetDir, sizeof(assetDir), "/SampleRenderer/4/");
...
physx::PxProfileZone*		 SampleApplication::getOrCreateProfileZone(PxFoundation& inFoundation) 
{ 	
#ifdef PHYSX_PROFILE_SDK
	if ( mProfileZone == NULL )
...
physx::PxProfileZone* SampleApplication::getOrCreateProfileZone(physx::PxProfileZoneManager& zoneManager)
{
#ifdef PHYSX_PROFILE_SDK
	if ( mProfileZone == NULL )
...
void SampleApplication::releaseProfileZone()
{
#ifdef PHYSX_PROFILE_SDK
	if ( m_renderer != NULL )
...
physx::PxProfileEventSender* SampleApplication::getEventBuffer() 
{ 
#ifdef PHYSX_PROFILE_SDK
