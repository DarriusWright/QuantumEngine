...
void RendererClothShape::mapShapes(RendererClothShape** shapes, PxU32 n)
{
	...
	ProfileZone p("RendererClothShape::mapGraphicsResource", shapes[0]->m_renderer.getProfileZone());
...
void RendererClothShape::unmapShapes(RendererClothShape** shapes, PxU32 n)
{
	...
	ProfileZone p("RendererClothShape::unmapGraphicsResource", shapes[0]->m_renderer.getProfileZone());
